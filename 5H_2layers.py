...
#👉🏼👉🏼Canvas settings:
#-------------------
canvas.window_title = "5H_2Layers"
...
#----------------------
canvas.gravity(0,500)  ###👈🏼👈🏼GRAVITY:(x,y)
...
fs_w_counter_B = make_fslocal("Diplöe", the_font_path, the_font_size, font_variations=the_fontVariations_B, lineHeight=the_font_size)
