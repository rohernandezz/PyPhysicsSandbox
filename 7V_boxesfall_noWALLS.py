def makeRender(variations,the_color):
    ...
    text_box_A = (20, -1100, rw*1.1, 2400)
    ...
    for wght_value in wght_list:
        for wdth_value in wdth_list:
            for slnt_value in slnt_list:
                ...
                #title = f"GreyVert_wdth{wdth_value}_wght{wght_value}_slnt{slnt_value}"
                title = f"GradVert_wdth{wdth_value}_wght{wght_value}_slnt{slnt_value}"
                print(f"💕 {title}")
