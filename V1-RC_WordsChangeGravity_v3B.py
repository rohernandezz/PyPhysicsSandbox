...
#👉🏼👉🏼Canvas settings:
#-------------------
canvas.window_title = "changeGravity03"
...
for i,origin in enumerate(origins_a):
    ...
    boxes_a[i].hit((-3200000,-50000000),(origin[0]+box_dimensions[0]/2,origin[1]-box_dimensions[1]/2))
print(boxes_a)    
