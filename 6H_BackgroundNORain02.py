...
#👉🏼👉🏼Canvas settings:
#-------------------
canvas.window_title = "6H_Background_NO_rain-STATE02b"
canvas.render_width  = 2000
canvas.render_height = 1000
canvas.frames_x_second = 30
canvas.simulation_render_time = 20
...
#----------------------
canvas.gravity(-290,450)  ###👈🏼👈🏼GRAVITY:(x,y)
