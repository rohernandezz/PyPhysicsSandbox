...
window('Floating_varGravity_reverse', w, h, fps=30)

gral_random_seed = 566
...
origins_a = [(300,700), (500,600),(170,350), (50,850),(1100,200), (1300,700),]
texts_a   = [ "Amplitude",
            "Above the Fold",
            "Off the Record",
            "Diffusion",
            ...
            "Realness",
            "hhdsjhfajsd",]
box_dimensions   = (600, 100)
boxes_a = {}

for i,origin in enumerate(origins_a):
    boxes_a[i] = textBox_with_font(origin,box_dimensions[0],box_dimensions[1],texts_a[i],"fonts/VF/DiploeVF.ttf",60)
    boxes_a[i].color    = Color("Black")
    boxes_a[i].db_color = (0,0,0,1)
