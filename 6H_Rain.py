...
#----------------------
canvas.gravity(500,200)  ###👈🏼👈🏼GRAVITY:(x,y)
...
fallingParagraph(fs_w_counter_B, text_box_B, text_color_name_B,the_font_path, the_font_size, font_variations=the_fontVariations_B,line_angle=randint(-5,10),category=cat2,gravity=(-60,500))
