...
window('Floating_Diploe_01', w, h, fps=30)
global_random_seed = 777777
#-----------------------------
gravity(50,-500)       ###👈🏼👈🏼GRAVITY
...
#### DrawBot
margin_from_bottom = 100
text_box = (100, margin_from_bottom, 800, h-margin_from_bottom-150)
