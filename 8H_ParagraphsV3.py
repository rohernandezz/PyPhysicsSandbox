...
text_box_A = (1100, -800, 800, 900)
#text_box_A2 = (1000, -750, 1000, 550)
...
a_ledge = static_box((1200,-800),900,20)
a_ledge.angle = 25
a_ledge.color = Color("Red")

fallingParagraph(fs_w_counter_A, text_box_B, text_color_name,the_font_path, the_font_size, font_variations=the_fontVariations_A,line_angle=5)
