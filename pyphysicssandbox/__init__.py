...
def run(do_physics=True):
    ...
    #### Setup a new frame to draw on:
        ...
        with drawBot.savedState():
            ...
            #drawBot.linearGradient(startPoint=(canvas.render_width,canvas.render_height), endPoint=(0,0), colors=the_colors) #HORIZ
            drawBot.linearGradient(startPoint=(canvas.render_width,0), endPoint=(0,0), colors=the_colors) #HORIZ
